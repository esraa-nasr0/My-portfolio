...
function Projects() {
  return (
    ...
    > 
      ...
      {/* Projects Grid */}
      <ul className="grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12 justify-center w-full max-w-6xl">
        {projects.map((project, index) => (
          ...
          >
            <Link href={project.demo} target="_blank" rel="noopener noreferrer">
              <div className="relative overflow-hidden rounded-2xl bg-gradient-to-b from-gray-800 to-black shadow-md hover:shadow-fuchsia-400/40 transition duration-500">
